<section class="sidebar">
    ...
    <!-- Pembuka siswa -->
            ...
            <?php if(!in_array($login_level,array('user kantin'))){ ?>
                ...
                <li class="treeview <?=@$page_active == 'pesan' ? 'active' : ''?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($login_level == 'administrator'|| $login_level == 'operator sekolah'){?>
        ...
        <!-- penutup siswa -->
        <?php } ?>
            <?php if(in_array($login_level, array('operator sekolah','user kantin','administrator','siswa'))){ ?>
            <?php if($login_level != 'siswa'){ ?>
            ...
            <li class="treeview <?=@$page_active == 'kantin' ? 'active' : ''?>">
                ...
                <?php } ?>
                <?php if(!in_array($login_level,array('user kantin','siswa'))){ ?>
