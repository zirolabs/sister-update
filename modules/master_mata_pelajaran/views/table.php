						...
						<?php foreach($data as $key => $c): ?>
							<tr>
								<td class="text-center">
									<a href="<?=site_url('master_mata_pelajaran/form/' . $c->mata_pelajaran_id)?>" class="btn btn-default btn-xs" title="Perbaharui / Update">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<a href="<?=site_url('master_mata_pelajaran')?>" id="btn-yes" class="btn btn-default">
...
<script type="text/javascript">
	...
	{
		$('#modal-hapus #btn-yes').attr({'href' : '<?=site_url('master_mata_pelajaran/hapus')?>/' + id});
		$('#modal-hapus').modal();
	}
</script>
