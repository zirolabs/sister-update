	...
	<div class="col-md-10 col-md-offset-1">
        <div class="box box-primary">
            ...
            <div class="box-body">
				...
				<hr/>
				<form class="form-horizontal" method="POST" action="<?=site_url('verifikasi_absensi/submit_belum_absen/' . $id . '?tanggal=' . $tanggal. '&kelas=' . $kelas . '&sekolah=' . $sekolah)?>" enctype="multipart/form-data" autocomplete="off">
					<table class="table table-striped">
						<tbody>
							<tr>
								<td class="col-md-2">NIS</td>
								<td><?=@$info_siswa->nis?></td>
							</tr>
							<tr>
								<td class="col-md-2">Nama</td>
								<td><?=@$info_siswa->nama?></td>
							</tr>
							<tr>
								<td class="col-md-2">Kelas</td>
								<td><?=@$info_siswa->nama_kelas?></td>
							</tr>
							<tr>
								<td class="col-md-2">Tanggal</td>
								<td><?=format_tanggal_indonesia($tanggal)?></td>
							</tr>
						</tbody>
					</table>
					<hr/>
						        ...
						        <div class="col-md-6">
						        	<div class="bootstrap-timepicker">
										<div class="input-group">
											<input type="text" class="form-control timepicker" name="waktu_masuk" value="<?=empty($data->waktu_masuk) ? date('H:i') : $data->waktu_masuk?>">
