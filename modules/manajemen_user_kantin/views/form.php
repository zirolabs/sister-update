<div class="row" style="margin-bottom: 10px;">
	<div class="col-md-12">
		<a href="<?=site_url('manajemen_user_kantin')?>" class="btn btn-default">
			<i class="fa fa-history"></i> Kembali
		</a>
	</div>
</div>

<form class="form-horizontal" method="POST" action="<?=site_url('manajemen_user_kantin/submit/' . $id)?>" enctype="multipart/form-data">
	<div class="row">
		<div class="col-md-4">
