<div class="box box-primary">
    <div class="box-header with-border">
    	<h3 class="box-title">
            <i class="fa fa-users"></i>&nbsp;&nbsp;&nbsp;Manajemen Operator Sekolah
        </h3>
    </div>
    <div class="box-body">
        <form method="GET" action="<?=site_url('manajemen_operator')?>">
        	<div class="row">
                <div class="col-md-1">
                    <div class="form-group">
                        <label>&nbsp;</label>
                        <div class="input-group">
                            <a href="<?=site_url('manajemen_operator/form')?>" class="btn btn-default btn-block">
						...
						<?php foreach($data as $key => $c): ?>
							<tr>
								<td class="text-center">
									<a href="<?=site_url('manajemen_operator/form/' . $c->user_id)?>" class="btn btn-default btn-xs" title="Perbaharui / Update">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<a href="<?=site_url('manajemen_operator')?>" id="btn-yes" class="btn btn-default">
...
<script type="text/javascript">
	...
	{
		$('#modal-hapus #btn-yes').attr({'href' : '<?=site_url('manajemen_operator/hapus')?>/' + id});
		$('#modal-hapus').modal();
	}
</script> 
