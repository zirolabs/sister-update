	...
	<div class="col-md-10 col-md-offset-1">
        <div class="box box-primary">
            ...
            <div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<a href="<?=site_url('mata_pelajaran_materi')?>" class="btn btn-default">
							<i class="fa fa-history"></i> Kembali
						</a>
					</div>
				</div>
				<hr/>
				<form class="form-horizontal" method="POST" action="<?=site_url('mata_pelajaran_materi/submit/' . $id)?>" enctype="multipart/form-data">
