...
class Mata_pelajaran_materi extends CI_Controller
{
	function __construct()
	{
		...
		$this->sub_page_active 	= 'mata_pelajaran_materi';
	}
	...
	public function index()
	{
		...
		$param['pagination']	= paging('mata_pelajaran_materi/index', $total_rows, $limit, $uri_segment);
	...
	public function form($id = '')
	{
		...
		$param['main_content']		= 'mata_pelajaran_materi/form';
		$param['page_active'] 		= $this->page_active;
		$param['sub_page_active'] 	= $this->sub_page_active;
		$this->templates->load('main_templates', $param);
	}
	...
	public function submit($id = '')
	{
		...
		if($this->form_validation->run() == false)
		{
			...
			redirect('mata_pelajaran_materi/form/' . $id);
		}
		else
		{
		...
		redirect('mata_pelajaran_materi');
	}
